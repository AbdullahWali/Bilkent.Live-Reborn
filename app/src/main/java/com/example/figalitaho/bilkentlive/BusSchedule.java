...
public class BusSchedule {
    ...
    public BusSchedule() {
        ...
        fromCityWeekendTime = new int[]{800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100 , 2200, 2300,2400,130};
        fromCityWeekdayTime = new int[] {750, 800, 840, 940, 1040, 1140, 1240, 1340, 1440, 1540, 1640, 1800, 1900, 2000, 2100, 2200, 2300, 2400, 130 };//2400 };
